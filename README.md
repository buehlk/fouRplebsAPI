...
#>  $ thread_id          : chr  "26606108" ...
#>  $ doc_id             : chr  "12908796" ...
#>  $ num                : chr  "26606108" ...
#>  $ subnum             : chr  "0" ...
#>  $ op                 : num  1 1 ...
#>  $ timestamp          : int  1654261201 1654260959 ...
#>  $ fourchan_date      : chr  "6/3/22(Fri)9:00" ...
#>  $ name               : chr  "Anonymous" ...
#>  $ title              : logi  NA ...
#>  $ referencing_comment: logi  NA ...
#>  $ comments           : chr  "Is 4chan bad for your mental health? Should"| __truncated__ ...
