...
#>  $ thread_id          : chr  "26681705" ...
#>  $ doc_id             : chr  "12984374" ...
#>  $ num                : chr  "26681705" ...
#>  $ subnum             : chr  "0" ...
#>  $ op                 : num  1 1 ...
#>  $ timestamp          : int  1655104915 1655104180 ...
#>  $ fourchan_date      : chr  "6/13/22(Mon)3:21" ...
#>  $ name               : chr  "Anonymous" ...
#>  $ title              : logi  NA ...
#>  $ referencing_comment: logi  NA ...
#>  $ comments           : chr  "For the first time I found a girl that want"| __truncated__ ...
